...
const STRINGS: Record<AssetLocale, Record<string, string>> = {
  "en": {
    ...
    built3: "Designed to the ISO/IEC 17024:2026 framework for bodies certifying persons.",
  ...
  "es-419": {
    ...
    built3: "Diseñada conforme al marco ISO/IEC 17024:2026 para organismos que certifican personas.",
  ...
  "pt-BR": {
    ...
    built3: "Projetada conforme a estrutura ISO/IEC 17024:2026 para organismos que certificam pessoas.",
