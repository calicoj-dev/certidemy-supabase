...
"GLOSSARY MARKUP IS FROZEN IN BOTH DIRECTIONS. Translate the LABEL inside an existing [label]{glossary=\"slug\"} and keep the slug byte-identical. NEVER ADD a glossary marker to a term that does not already carry one in the English, even where that term is glossed elsewhere in the course. If the English prose says interested parties or nonconformity as plain text, it stays plain text. The count and set of glossary slugs in your output must match the English EXACTLY - adding one fails the file.",
