# AIE-I — Job-Task Analysis (v1.0 DRAFT)

**Document version:** 1.0 (draft — pending Grok Expert review)
**Status:** Draft for review. Not yet locked for content production.
...
**Last updated:** July 10, 2026 (v1.0 — initial draft)
...
## Open questions for Grok review

1. **Coverage gap check** — does any established AI-literacy cert (CertiProf AIFPC,
   AWS AIF-C01, Google AI Essentials, IBM, ICAgile) cover a topic our 3 domains miss
   that an employer would expect? And is anything here *fluff* to cut for a 25-item exam?
2. **Domain 1 vs 2 weight** — is 40/36 right, or should "Working with GenAI" (the
   daily hands-on skill) carry equal or greater weight than "Concepts"?
3. **Agentic AI (Task 1.4)** — appropriate at the literacy tier in mid-2026, or too
   advanced for a non-technical entry cert? (Leaning keep — agents are now mainstream.)
4. **Bloom mix** — is 44/40/16 (Remember/Understand/Apply) right for "literacy," or
   should Apply be a touch higher for workplace credibility?
5. **Article 4 positioning** — how hard to lean on "audit-ready Article 4 evidence" in
   marketing without overclaiming (AIE-I is *a* literacy measure, not a compliance
   guarantee).
6. **Validity period** — 2 years vs. lifetime for the free tier.
