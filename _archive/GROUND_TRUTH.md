...
>
> This document was the content-production authority when Certidemy was conceived as
> **exam prep for CertiProf's SMPC**. Nothing references it today, and its framing
> ("Certification: CertiProf SMPC", "pasted into every Grok and Gemini call") describes
> a product that no longer exists.
>
> **Certidemy now issues its own proprietary credentials.** For content production see
> `supabase/CERT-CREATION.md` (the staged playbook), `supabase/LESSON_AUTHORING_SPEC.md`
> (authoring rules), and `supabase/TERMINOLOGY-POLICY.md`. The authoritative JTA for any
> certification is `supabase/jta/<CODE>_JTA_generated.md`, rendered from the database.
>
> Kept because it records what was decided and why. Do not author from it.

---

# GROUND TRUTH — Certidemy SMPC Content Production

**Purpose:** This document is the single source of authority for generating
Certidemy SMPC lesson content. It is pasted into every Grok and Gemini call
during content production. When any source disagrees with this document, this
document wins — and within it, the 2020 Scrum Guide is supreme.

**Certification:** CertiProf Scrum Master Professional Certificate (SMPC).
This is NOT Scrum.org's PSM I. Both rest on the 2020 Scrum Guide, but they are
different exams with different question styles. Do not import PSM-specific
advice or assume PSM-specific emphasis.

---

# PART 1 — The 2020 Scrum Guide

> ============================================================================
> PASTE INSTRUCTION
> ----------------------------------------------------------------------------
> Go to https://scrumguides.org/scrum-guide.html
> Select the entire guide text (from "Purpose of the Scrum Guide" through the
> end, including the "Acknowledgements" / "End Note" if present).
> Copy it, and paste it BELOW this line, replacing this whole instruction block.
>
> Do not summarize or edit it — paste the exact text. Its precise wording is
...
# PART 2 — The Scrum Glossary

> ============================================================================
> PASTE INSTRUCTION
> ----------------------------------------------------------------------------
> Go to https://scrumguides.org/scrum-glossary.html
> Select the entire glossary (all terms and their definitions).
> Copy it, and paste it BELOW this line, replacing this whole instruction block.
> ============================================================================
...
# PART 3 — SMPC Job-Task Analysis (v2 FINAL)

This is Certidemy's authoritative task breakdown for the SMPC certification.
Lessons and questions map to the tasks defined here.
...
- Source material: 2020 Scrum Guide, Agile Manifesto, Agile Alliance Glossary,
  Essential Scrum (Kenneth Rubin)
- Languages: English, Spanish, Portuguese, others

## Domain structure (5 domains, weights sum to 100%)
...
## Bloom's Taxonomy distribution (MCQ target across 40 questions)

| Bloom level | Target % | Count | Style |
|-------------|----------|-------|-------|
| 1 — Remember | 15% | 6 | Direct recall |
| 2 — Understand | 35% | 14 | Explanation / comparison |
| 3 — Apply | 35% | 14 | Short scenarios |
| 4 — Analyze | 15% | 6 | Multi-step diagnosis |
| 5-6 — Evaluate/Create | 0% in MCQs | 0 | Reserved for AI simulations |

MCQs cap at Bloom 4. Certidemy deliberately weights Apply/Analyze higher than
typical prep platforms so learners over-prepare relative to the actual exam.

## CertiProf-specific terminology drift

The 2020 Scrum Guide is canonical. CertiProf prep materials sometimes lag in
terminology. Content teaches the Guide as authoritative, then flags drift as
exam-tip callouts.

| Scrum Guide 2020 (canonical) | CertiProf materials sometimes use | Content position |
|------------------------------|-----------------------------------|------------------|
...
| True leaders who serve | Servant leaders | Teach both; servant leadership concept remains |
| (No specific charts prescribed) | Burndown charts, velocity | Teach as common practice; note Guide is tool-agnostic |
| Refinement (activity, not event) | Refinement (sometimes an event) | Teach as ongoing activity, not a formal event |

## The 44 tasks

The full task list — Domain 1 (6 tasks), Domain 2 (9), Domain 3 (10),
Domain 4 (10), Domain 5 (9) — is maintained in SMPC_JTA_v2.md. For a given
lesson, the relevant task(s), their Bloom level, exam-scope flag, and concept
slugs are supplied in the per-lesson brief. Treat those brief details as
binding for that lesson.

---

# PART 4 — Content rules

Any content generated against this document must follow these:

1. **The 2020 Scrum Guide is supreme.** If anything — community lore, an
   AI's training knowledge, an older book — contradicts the Guide text in
   Part 1, the Guide wins. Where the Guide is silent, say so explicitly
   rather than inventing authority.

2. **SMPC, not PSM I.** Content targets the CertiProf SMPC exam. Do not import
   Scrum.org PSM-specific framing.

3. **Terminology.** Teach the 2020 Guide term as correct. Where CertiProf uses
   a legacy term, flag the drift — don't silently use the legacy term, and
   don't treat the legacy term as shameful.

4. **No fabricated authority.** No invented quotes, no invented citations, no
   statistics that can't be traced to a real source.

5. **Honesty about uncertainty.** If the Guide doesn't settle a point, the
   content says the Guide is silent and explains the common practice instead.

6. **Localization-friendly.** Avoid idioms and culturally-specific examples;
   content will be translated to Latin American Spanish and Brazilian
   Portuguese.

---

**End of Ground Truth packet.** Parts 1 and 2 must be filled in before this is
used. Parts 3 and 4 are complete.
