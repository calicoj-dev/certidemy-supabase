# SMPC — Job-Task Analysis (v2 FINAL)

**Document version:** 2.0
**Status:** Locked. This is the basis for content production.
**Certification:** CertiProf Scrum Master Professional Certificate (SMPC), v2020
...
5. Added **terminology drift** tasks per domain — explicit teaching of where CertiProf prep materials use legacy terms
...
8. Updated SMPC `passing\_score\_pct` from 70% to **80%** (verified: 32/40)
...
**Why this is more rigorous than CertiProf's actual exam:** Most certification prep platforms train almost exclusively at Levels 1-2 because those are easiest to write. By placing 50% of questions at Apply/Analyze, Certidemy learners over-prepare for the actual exam. The marketing claim: *Train to a higher standard than the test.*

\---

## CertiProf-specific terminology drift

The Scrum Guide 2020 is canonical, but CertiProf prep materials sometimes lag in terminology. Our content teaches the Scrum Guide as authoritative, then flags drift as exam-tip callouts.

|Scrum Guide 2020 (canonical)|CertiProf materials sometimes use|Our content position|
|-|-|-|
...
**Description.** The five Scrum events. Each event's timebox, attendees, purpose, and output. The most heavily-tested domain on the SMPC exam because events are concrete and easy to construct questions around.
...
### Task 4.9 — Interpret burndown charts and velocity metrics (CertiProf emphasis)
...
* **K:** Burndowns show remaining work over time; velocity = points completed per Sprint; both are forecasting tools, not performance metrics; the Scrum Guide is tool-agnostic but CertiProf commonly tests these
...
**Description.** Everything that's not framework definition: facilitation, coaching stances, impediment removal, conflict, psychological safety, organizational adoption, scaling (lightly), and the terminology drift between CertiProf prep materials and the 2020 Scrum Guide. This is where Certidemy's content goes deeper than CertiProf's own and where adaptive depth pays off.
...
### Task 5.7 — Navigate CertiProf vs. Scrum Guide terminology drift (EXAM TIP)
...
* **K:** Where CertiProf prep materials use legacy terms ("ceremonies," "self-organizing," "servant-leader"); which is exam-correct (Scrum Guide 2020 wins)
...
* **3 explicit terminology-drift tasks** (Tasks 2.6, 5.4, 5.7) so learners aren't blindsided by CertiProf phrasing
