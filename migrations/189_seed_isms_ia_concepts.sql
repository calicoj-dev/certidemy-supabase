-- 189_seed_isms_ia_concepts.sql
-- ISMS-IA spine, part 2 of 2: 169 concepts + 169 task_concepts links.
--
-- Source: ISMS-IA_CONCEPTS_v2.0 (companion to ISMS-IA_JTA_v2.0)
--
-- WHY TWO STATEMENTS AND NOT A DATA-MODIFYING CTE:
--
--   A CTE of the form `with ins as (insert into concepts ... returning ...)`
--   followed by an insert into task_concepts that JOINS public.concepts does
--   NOT see the rows the CTE inserted - every CTE reads the same snapshot.
--   Joining the RETURNING output instead works on a first run but breaks on a
--   replay, because `on conflict do nothing` returns nothing for rows that
--   already exist and the links are then silently skipped.
--
--   Two plain statements are fully idempotent in both directions. The cost is
--   that the slug list appears twice. A slug that differs between the two lists
--   produces FEWER THAN 169 LINKS AND NO ERROR - which is exactly what the
--   verification block at the foot checks for.
--
-- concepts_certification_id_slug_key is UNIQUE (certification_id, slug) - i.e.
-- PER CERT, introspected 2026-08-09. The ia- prefix is therefore convention and
-- readability, not collision protection. (modules.slug IS table-wide unique;
-- the two tables differ. See 188.)
--
-- No concept is linked by more than one task in this version: 169 concepts,
-- 169 links, a clean 1:1. Reuse is legitimate but should be a decision, and
-- stating 1:1 makes the count checkable.
...
select '7c3f1e88-4b2a-4d51-9e6c-2a8f5b3d0417'::uuid, v.slug, v.name, v.description
from (values
...
('ia-terms-defined-outside-27001','ISO/IEC 27001 terms live elsewhere',$$Clause 3 delegates all terms and definitions to ISO/IEC 27000 through an undated normative reference. Nonconformity, correction, corrective action and audit are not defined inside ISO/IEC 27001.$$),
...
-- D4 / 4.7  (wording pending verification of Amendment 1:2024)
...
('ia-audit-requirement-divergence-27001-42001','Audit requirements diverge',$$ISO/IEC 27001 clause 9.2.2 a) requires audit criteria and scope; ISO/IEC 42001 requires objectives, criteria and scope. ISO/IEC 27001 reports results to relevant management; ISO/IEC 42001 to relevant managers.$$),
...
('ia-statement-objectivity','Objectivity in the statement',$$ISO 19011:2026 fair presentation principle requires findings, conclusions and reports to reflect the auditing activities truthfully and accurately. The statement records what was found; it does not prescribe the remedy or characterise the auditee.$$),
...
('ia-reader-judgement-of-evidence-reliability','Enabling the reader judgement',$$The test for disclosure is whether a reader could reach a different view of the conclusions if they knew how the evidence was selected and processed.$$),
...
-- ---------------------------------------------------------------------------
-- 2. TASK_CONCEPTS  (169 links; ids resolved by join on task code and slug)
-- ---------------------------------------------------------------------------

insert into public.task_concepts (task_id, concept_id)
select t.id, c.id
from (values
('1.1','ia-first-party-audit-purpose'),('1.1','ia-second-party-audit-context'),('1.1','ia-third-party-certification-audit'),('1.1','ia-who-may-conduct-each-audit-type'),('1.1','ia-19011-table-1-audit-types'),('1.1','ia-annex-a-5-35-independent-review'),('1.1','ia-clause-9-2-versus-control-5-35'),
('1.2','ia-audit-principles-set'),('1.2','ia-principles-carry-no-precedence'),('1.2','ia-principle-interaction-in-practice'),('1.2','ia-independence-vs-due-care-tension'),('1.2','ia-evidence-based-vs-risk-based-tension'),
('1.3','ia-objectivity-in-first-party-audit'),('1.3','ia-clause-9-2-2-objectivity-requirement'),('1.3','ia-independence-of-the-activity-audited-4-6'),('1.3','ia-internal-auditor-limited-independence-remedy'),('1.3','ia-small-organization-independence-constraints'),('1.3','ia-compensating-arrangements-for-limited-independence'),
('1.4','ia-auditor-competence-elements'),('1.4','ia-isms-specific-auditor-competence'),('1.4','ia-ict-and-emerging-technology-competence-7-2-3'),('1.4','ia-ai-tool-competence-for-auditors'),('1.4','ia-team-competence-versus-individual-competence'),
('1.5','ia-19011-is-guidance-not-requirements'),('1.5','ia-27001-requirements-as-audit-criteria'),('1.5','ia-17021-1-governs-certification-bodies'),('1.5','ia-no-certification-to-19011'),('1.5','ia-terms-defined-outside-27001'),

('2.1','ia-audit-programme-objectives'),('2.1','ia-isms-objectives-as-programme-input'),('2.1','ia-previous-audit-results-as-input'),('2.1','ia-interested-party-requirements-as-input'),
('2.2','ia-risk-based-audit-programme'),('2.2','ia-programme-risks-and-opportunities-5-3'),('2.2','ia-process-importance-as-prioritisation-factor'),('2.2','ia-coverage-across-programme-cycle'),('2.2','ia-clause-order-carries-no-priority'),
('2.3','ia-audit-scope-definition-3-6'),('2.3','ia-audit-criteria-3-8'),('2.3','ia-individual-audit-objectives'),('2.3','ia-scope-boundaries-and-exclusions'),('2.3','ia-audit-objectives-are-practice-not-a-27001-requirement'),
('2.4','ia-on-site-auditing-method'),('2.4','ia-remote-auditing-method-3-4'),('2.4','ia-virtual-locations'),('2.4','ia-method-selection-5-5-3'),('2.4','ia-remote-method-risks-annex-a-16'),
('2.5','ia-audit-team-selection-5-5-4'),('2.5','ia-technical-expert-role'),('2.5','ia-audit-programme-resources-5-4-4'),('2.5','ia-audit-team-leader-assignment-5-5-5'),
('2.6','ia-planned-intervals-carries-no-fixed-value'),('2.6','ia-clause-9-2-1-requirements'),('2.6','ia-clause-9-2-2-programme-requirements'),('2.6','ia-audit-programme-3-5'),('2.6','ia-documented-information-on-the-programme'),
('2.7','ia-ai-systems-in-isms-scope'),('2.7','ia-ai-change-velocity-and-audit-frequency'),('2.7','ia-ai-supplier-and-model-dependency'),('2.7','ia-shadow-ai-in-programme-planning'),

('3.1','ia-audit-evidence-3-10'),('3.1','ia-objective-evidence-versus-audit-evidence'),('3.1','ia-degree-of-verification'),('3.1','ia-professional-judgement-on-reliance'),('3.1','ia-unverifiable-information-handling'),
('3.2','ia-sampling-and-confidence-in-conclusions'),('3.2','ia-sampling-guidance-annex-a-6'),('3.2','ia-judgement-based-sampling'),('3.2','ia-statistical-sampling'),('3.2','ia-sample-adequacy-for-conclusion'),
('3.3','ia-electronic-evidence-reliability'),('3.3','ia-witnessed-access-and-screen-share'),('3.3','ia-evidence-provenance-in-remote-audit'),('3.3','ia-remote-method-additional-risks'),
('3.4','ia-interviews-as-collection-method'),('3.4','ia-observation-as-collection-method'),('3.4','ia-review-of-documented-information'),('3.4','ia-re-performance-as-evidence-source'),
('3.5','ia-interview-guidance-annex-a-17'),('3.5','ia-open-versus-closed-questions'),('3.5','ia-corroboration-across-interviewees'),
('3.6','ia-statement-of-applicability-claim'),('3.6','ia-control-design-versus-operating-effectiveness'),('3.6','ia-annex-a-control-testing'),('3.6','ia-control-implementation-evidence'),
('3.7','ia-annex-a-8-34-audit-testing-agreement'),('3.7','ia-isms-audit-boundary'),('3.7','ia-technical-expert-engagement-trigger'),('3.7','ia-audit-feasibility-6-2-3'),
('3.8','ia-ai-evaluation-tools-in-auditor-competence-7-2-3'),('3.8','ia-ai-summary-is-not-verified-information'),('3.8','ia-ai-tool-output-provenance'),('3.8','ia-auditor-accountability-for-ai-assisted-conclusions'),('3.8','ia-ai-selection-bias-in-evidence-sampling'),
('3.9','ia-evidence-to-finding-traceability'),('3.9','ia-audit-records-5-5-7'),('3.9','ia-evidence-retention-and-confidentiality'),

('4.1','ia-isms-scope-clause-4-3'),('4.1','ia-interfaces-and-dependencies'),('4.1','ia-clauses-4-to-10-not-excludable'),('4.1','ia-internal-and-external-issues-clause-4-1'),
('4.2','ia-leadership-commitment-clause-5-1'),('4.2','ia-information-security-policy-clause-5-2'),('4.2','ia-policy-availability-and-communication'),('4.2','ia-roles-responsibilities-authorities-clause-5-3'),('4.2','ia-evidence-of-commitment-versus-statement-of-commitment'),
('4.3','ia-risk-assessment-process-clause-6-1-2'),('4.3','ia-risk-acceptance-criteria'),('4.3','ia-risk-treatment-process-clause-6-1-3'),('4.3','ia-annex-a-as-completeness-check'),('4.3','ia-no-risk-register-requirement'),('4.3','ia-information-security-objectives-clause-6-2'),('4.3','ia-planning-of-changes-clause-6-3'),
('4.4','ia-soa-four-required-elements'),('4.4','ia-soa-inclusion-and-exclusion-justification'),('4.4','ia-soa-versus-risk-treatment-plan-consistency'),('4.4','ia-risk-owner-approval-of-treatment-plan'),
('4.5','ia-competence-clause-7-2'),('4.5','ia-awareness-clause-7-3'),('4.5','ia-documented-information-clause-7-5'),('4.5','ia-control-of-documented-information'),
('4.6','ia-operational-planning-and-control-clause-8-1'),('4.6','ia-risk-assessment-and-treatment-in-operation-clause-8-2-8-3'),('4.6','ia-monitoring-and-measurement-clause-9-1'),('4.6','ia-who-monitors-and-who-evaluates'),('4.6','ia-clause-6-defines-clause-8-performs'),
('4.7','ia-amendment-1-2024-climate-change'),('4.7','ia-climate-change-as-a-4-1-issue'),('4.7','ia-interested-party-climate-requirements-4-2'),
('4.8','ia-ai-derived-information-assets'),('4.8','ia-model-weights-and-training-data-as-assets'),('4.8','ia-prompt-and-inference-logs'),('4.8','ia-shadow-ai-discovery'),
('4.9','ia-non-deterministic-process-control-challenge'),('4.9','ia-control-effectiveness-drift'),('4.9','ia-human-review-of-ai-output-as-control'),
('4.10','ia-27001-42001-scope-overlap'),('4.10','ia-combined-audit-3-2'),('4.10','ia-isms-competence-does-not-satisfy-aims-competence'),('4.10','ia-42001-annex-d-integration-guidance'),('4.10','ia-management-review-input-divergence'),('4.10','ia-audit-requirement-divergence-27001-42001'),

('5.1','ia-finding-classification-scheme'),('5.1','ia-audit-finding-3-11'),('5.1','ia-compliance-versus-conformity-language'),('5.1','ia-opportunity-for-improvement'),('5.1','ia-classification-scheme-is-an-organizational-choice'),
('5.2','ia-nonconformity-determination'),('5.2','ia-generating-audit-findings-6-4-8'),('5.2','ia-isolated-versus-systemic-failure'),('5.2','ia-absence-of-evidence-versus-evidence-of-absence'),
('5.3','ia-nonconformity-statement-structure'),('5.3','ia-requirement-to-evidence-link'),('5.3','ia-statement-objectivity'),
('5.4','ia-audit-report-content-6-5-1'),('5.4','ia-ai-assisted-method-disclosure'),('5.4','ia-reader-judgement-of-evidence-reliability'),('5.4','ia-disclosure-proportionality'),
('5.5','ia-correction-versus-corrective-action'),('5.5','ia-root-cause-analysis-adequacy'),('5.5','ia-clause-10-2-requirements'),('5.5','ia-recurrence-prevention'),
('5.6','ia-corrective-action-verification'),('5.6','ia-audit-follow-up-6-7'),('5.6','ia-finding-closure-criteria'),
('5.7','ia-audit-results-as-management-review-input'),('5.7','ia-management-review-inputs-clause-9-3-2'),('5.7','ia-reporting-results-to-relevant-management'),('5.7','ia-fulfilment-of-objectives-as-input')
) as v(task_code, slug)
join public.tasks t
  on t.certification_id = '7c3f1e88-4b2a-4d51-9e6c-2a8f5b3d0417'::uuid and t.code = v.task_code
join public.concepts c
  on c.certification_id = '7c3f1e88-4b2a-4d51-9e6c-2a8f5b3d0417'::uuid and c.slug = v.slug
...
-- ---------------------------------------------------------------------------
--
-- THE CHECK THAT MATTERS. A slug that differs between the two lists above
-- produces fewer than 169 links and NO ERROR. Expect 169 / 169:
--
--   select
--     (select count(*) from public.concepts where certification_id = '7c3f1e88-4b2a-4d51-9e6c-2a8f5b3d0417') as concepts,
--     (select count(*) from public.task_concepts tc
--        join public.tasks t on t.id = tc.task_id
--       where t.certification_id = '7c3f1e88-4b2a-4d51-9e6c-2a8f5b3d0417') as links;
--
-- Orphan concepts - concepts linked by no task. Expect 0:
--
--   select c.slug from public.concepts c
--   where c.certification_id = '7c3f1e88-4b2a-4d51-9e6c-2a8f5b3d0417'
--     and not exists (select 1 from public.task_concepts tc where tc.concept_id = c.id);
--
-- Concepts per task - expect 38 rows, counts 3 to 7, no task at 0:
--
--   select t.code, count(tc.concept_id) as concepts
--   from public.tasks t
--   left join public.task_concepts tc on tc.task_id = t.id
--   where t.certification_id = '7c3f1e88-4b2a-4d51-9e6c-2a8f5b3d0417'
--   group by t.code, t.order_index order by t.order_index;
--
-- Reuse check - this version is 1:1, so expect 0 rows:
--
--   select c.slug, count(*) from public.concepts c
--   join public.task_concepts tc on tc.concept_id = c.id
--   where c.certification_id = '7c3f1e88-4b2a-4d51-9e6c-2a8f5b3d0417'
--   group by c.slug having count(*) > 1;
--
-- The two concepts carrying a pending-verification hedge (task 4.7). These come
-- out when Amendment 1:2024 is read directly:
--
