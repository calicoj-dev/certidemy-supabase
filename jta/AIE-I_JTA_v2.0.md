...
>
> **The authoritative JTA for AIE-I is `jta/AIE-I_JTA_generated.md`**, rendered
...
> **3 task statement(s)** and is **missing 2 task(s)** entirely. Its exam
...
> has not been moved yet. It will be extracted into `AIE-I_JTA_narrative.md`,
